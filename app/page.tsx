...
import { ArrowRight, Users, Shield, Zap, Sparkles, Code, Rocket, Star, Globe, Award } from "lucide-react"
        ...
        <div className="content-container h-20">
          <div className="flex h-full items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <Link href="/login">
                <Button variant="ghost" className="font-medium text-foreground hover:text-primary transition-all duration-300 rounded-xl px-6">
                  Login
                </Button>
              </Link>
              <Link href="/register">
            ...
            <div className="mx-auto max-w-6xl space-y-12 px-4">
              ...
              <div className="flex justify-center mb-12 floating-element">
                <div className="relative">
                  ...
                  <HackClubLogo size="xl" showText={false} className="relative z-10" />
                </div>
              </div>
              ...
              <div className="space-y-8">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm">
                  ...
                  <span className="text-sm font-medium">Join 500+ Amazing Developers</span>
                </div>
                
                <h1 className="hero-title">
                  Build the <span className="gradient-text-secondary">Future</span> of 
                  <br />
                ...
                <p className="text-xl sm:text-2xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
                  ...
                  <span className="gradient-text font-bold"> builders, creators, and visionaries </span>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-20">
                ...
                <div className="stats-card floating-element">
                  <div className="text-4xl font-black gradient-text-secondary mb-2">50+</div>
                ...
                <div className="stats-card floating-element">
                  <div className="text-4xl font-black gradient-text-accent mb-2">10+</div>
                  <div className="text-muted-foreground font-medium">Departments</div>
                  <div className="absolute top-4 right-4">
          ...
          <div className="content-container">
            <div className="text-center mb-20 px-4">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Experience the next generation of <span className="gradient-text-accent font-bold">community-driven development</span>
              </p>
            </div>
            ...
            <div className="feature-grid px-4">
              <div className="feature-card">
                ...
                <h3 className="text-2xl font-bold gradient-text mb-4">Elite Community</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Join an exclusive network of passionate developers, designers, and innovators 
              ...
              <div className="feature-card">
                ...
                <h3 className="text-2xl font-bold gradient-text-secondary mb-4">Learn by Creating</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Master cutting-edge technologies through hands-on projects that solve real-world 
              ...
              <div className="feature-card">
                ...
                <h3 className="text-2xl font-bold gradient-text-accent mb-4">Ship at Light Speed</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Transform your wildest ideas into reality with our rapid prototyping culture 
                  and cutting-edge development stack.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="neo-card p-16 text-center relative overflow-hidden card-stack">
              ...
              <div className="relative z-10">
                ...
                <h2 className="section-title gradient-text mb-8">
                  Ready to <span className="gradient-text-secondary">Level Up</span>?
                </h2>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between px-4">
            ...
            <div className="mt-4 md:mt-0">
              <p className="text-muted-foreground">
                © 2024 HackClub. Crafted with <span className="gradient-text">❤️</span> by the community.
              </p>
            </div>
          </div>
        </div>
