    ...
    <div className="min-h-screen flex items-center justify-center modern-bg">
      <div className="max-w-2xl mx-auto text-center px-4">
        ...
        <div className="mb-8 flex justify-center">
          <HackClubLogo size="lg" />
        </div>

        {/* Main Content */}
        <div className="space-y-6">
          <div className="space-y-4">
            <h1 className="text-6xl font-black gradient-text">Recruitment Ended</h1>
            <h2 className="text-3xl font-bold text-foreground">
              Thank You for Your Interest!
            </h2>
            <p className="text-xl text-muted-foreground leading-relaxed">
              Our recruitment season has officially concluded. We're grateful for all 
              the amazing applications we received and the incredible talent we've 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-8">
            <div className="neo-card p-6 text-center">
              ...
              <h3 className="font-semibold text-foreground mb-2">Recruitment Closed</h3>
          ...
          {/* Additional Info */}
          <div className="mt-12 p-6 neo-card bg-gradient-to-r from-pink-500/10 via-purple-500/10 to-cyan-500/10 border-primary/20">
            <h3 className="font-semibold text-foreground mb-3">
              What's Next?
            </h3>
            <p className="text-muted-foreground text-sm leading-relaxed">
              While our recruitment season has ended, we encourage you to stay connected 
              with the HackClub community. Follow our social media channels and keep an 
              eye out for future opportunities to join our amazing community of builders 
              and creators.
            </p>
          </div>
        </div>
