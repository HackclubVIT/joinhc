...
import { Eye, EyeOff, Mail, Lock, ArrowLeft, ChevronRight, Sparkles, Zap } from "lucide-react"
        ...
        <div className="relative z-10 max-w-md text-center space-y-8">
          ...
          <div className="flex items-center justify-center space-x-6 py-8">
            <div className="flex flex-col items-center group">
              ...
              <span className="text-sm text-foreground mt-2 font-medium">Login</span>
            </div>
            ...
            <div className="flex flex-col items-center opacity-50">
              ...
              <span className="text-sm text-muted-foreground mt-2">Dashboard</span>
            </div>
          ...
          <div className="space-y-4 text-left">
            <div className="flex items-center space-x-3 group">
              ...
              <span className="text-foreground group-hover:text-primary transition-colors">Secure Authentication</span>
            </div>
            <div className="flex items-center space-x-3 group">
              <div className="w-8 h-8 rounded-lg bg-blue-500/20 flex items-center justify-center">
                <Sparkles className="h-4 w-4 text-blue-400" />
              </div>
              <span className="text-foreground group-hover:text-primary transition-colors">Instant Access</span>
            </div>
            <div className="flex items-center space-x-3 group">
              <div className="w-8 h-8 rounded-lg bg-purple-500/20 flex items-center justify-center">
                <Sparkles className="h-4 w-4 text-purple-400" />
              </div>
              <span className="text-foreground group-hover:text-primary transition-colors">Premium Features</span>
            </div>
          </div>
        </div>
      </div>
                ...
                <Dialog open={showResetDialog} onOpenChange={setShowResetDialog}>
                  ...
                  <DialogContent className="neo-card border-0">
                    ...
                    <div className="space-y-4">
                      <div className="space-y-2">
                        <Label htmlFor="reset-email" className="text-gray-200">Email Address</Label>
                        <div className="relative">
